...
/**
 * [org.scijava.ui.behaviour.ClickBehaviour] that waits [timeout] for confirmation by re-executing the behaviour.
 * Executes [armedAction] on first invocation, and [confirmAction] on second invocation, if
 * it happens within [timeout].
 *
 * @author Ulrik Guenther <hello@ulrik.is>
 */
class ConfirmableClickBehaviour(val armedAction: (Long) -> Any, val confirmAction: (Long) -> Any, var timeout: Long = 3000):
    ClickBehaviour {
